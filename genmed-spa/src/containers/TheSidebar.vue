<template>
  <CSidebar fixed :minimize="minimize" :show="show" @update:show="(value) => $store.commit('set', ['sidebarShow', value])" theme="danger">
    <CSidebarBrand class="d-md-down-none" to="/">
      <CIcon class="" name="logo" size="custom-size" :height="35" viewBox="0 0 556 134" />
